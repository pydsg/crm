package com.huike.web.controller.common.minIO.controller;

import com.alibaba.fastjson.JSON;

import com.huike.common.utils.uuid.UUID;
import com.huike.web.controller.common.minIO.constant.CommonConstants;
...
public class FileController {
     ...
     */
    //@PostMapping("/upload")
    public ResultBean upload(MultipartFile[] file, String newDate) {
        ...
        for (MultipartFile multipartFile : file) {
            ...
            //文件格式
            String fileLastName = orgFileName.substring(orgFileName.lastIndexOf("."));

            orgFileNameList.add(fileLastName);
            try {
                //文件上传
                InputStream in = multipartFile.getInputStream();
                minioClient.putObject(
                        PutObjectArgs.builder().bucket(bucketName).object("/"+newDate+"/"+ UUID.fastUUID() +fileLastName).stream(
